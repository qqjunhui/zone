class upload {
    constructor() {
        ...
        this.size = 1024;
        this.containerStyle = {width: 300, border: "1px solid rgba(0,0,0,0)"};
        ...
        this.Pstyle = {width: 300, border: "1px solid rgba(0,0,0,0)", " border-radius:": 5}
        this.listStyle = {width: 100, height: 100, border: "1px solid rgba(0,0,0,0)", margin: 5}
        //  放的是具有数据的列表视图
        this.lists = [];
